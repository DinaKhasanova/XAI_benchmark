...
import yaml
import copy
from regression.factories.datasets import DataFactory
from regression.factories.models import ModelFactory
from regression.config import Config
import numpy as np
import regression.custom_representation
...
if __name__ == "__main__":
    main(
        ...
        dataset_path=["/home/dina/regression/src/regression/data/FG_count.csv"]
)
