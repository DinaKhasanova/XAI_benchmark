...
import yaml
import copy
from xai_benchmark.factories.datasets import DataFactory
from xai_benchmark.factories.models import ModelFactory
from xai_benchmark.config import Config
import numpy as np
import xai_benchmark.custom_representation
...
if __name__ == "__main__":
    main(
        ...
        dataset_path=["/home/dina/xai_methods/src/xai_benchmark/data/ames_FG.csv"]
)
