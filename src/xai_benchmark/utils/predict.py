...
from xai_benchmark.data_modules.datasets_and_collate_functions import (
    GraphDataset,
    mol_collate_fn,
    CNNDataset,
    CNN_collate_fn,
...
from xai_benchmark.utils.convert_representations import convert_dataset
...
class BaselinePredictor:
    ...
    def get_y_pred_and_y_true(self):
        ...
        y_pred = np.random.choice(
            [0, 1], size=(len(test_data), len(label_columns)), p=[1 - class_imbalance, class_imbalance]
        )
