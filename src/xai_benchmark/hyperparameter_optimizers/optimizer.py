...
import torch
from xai_benchmark.utils.plot_roc import plot_roc
import pandas as pd
from xai_benchmark.xai.shap import calculate_shap
from xai_benchmark.xai.ig import calculate_ig
from xai_benchmark.xai.deeplift import calculate_deeplift
from xai_benchmark.xai.occlusion import calculate_occlusion
from xai_benchmark.xai.captum_gradcam_all_layers import calculate_grad_cam_all_layers
...
class Optimizer(Generic[T], ABC):
    ...
    def test_model(self) -> None:
        ...
        plot_roc(y_preds=y_pred_numpy, y_trues=y_true_numpy, save_location=self.subfolder_path)

        print("calculate xai methods")
        ...
        calculate_grad_cam_all_layers(model.model, test_loader=test_dataloader, filter_sizes=filter_sizes, save_dir=gradcam_dir, device="cuda")
